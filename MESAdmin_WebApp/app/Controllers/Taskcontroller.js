(function () {
    ...
    function controller($scope, $timeout, uiGridConstants
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                { field: 'ProjectName', displayName: 'ReleaseName', pinnedLeft: true, width: '20%', enableCellEdit: false, cellTooltip: function (row) { return row.entity.ProjectName; }, cellTemplate: '<div class="ui-grid-cell-contents wrap" white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>', visible: false },
                { field: 'DefectName', pinnedLeft: true, displayName: 'TaskName', enableCellEdit: false, width: '20%', cellTooltip: function (row) { return row.entity.DefectName; }, cellTemplate: '<div class="ui-grid-cell-contents wrap" white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>', visible: true },
                { field: 'Priority', width: '10%', enableCellEdit: false, visible: false},
                { field: 'BusReqCompleteDate', displayName: 'BusReq', enableCellEdit: false, width: '7%', cellTooltip: function (row) { return row.entity.BusReqCompleteDate; }, cellTemplate: '<div class="ui-grid-cell-contents wrap" white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>', visible: false },
                { field: 'Status', width: '10%', enableCellEdit: false, visible: false},
                { field: 'PlanStartDate', displayName: 'PlanStart', enableCellEdit: false, width: '7%', cellTooltip: function (row) { return row.entity.PlanStartDate; }, cellTemplate: '<div class="ui-grid-cell-contents wrap" white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>', visible: false },
                { field: 'PlanCompleteDate', displayName: 'PlHours', enableCellEdit: false, width: '7%', cellTooltip: function (row) { return row.entity.PlanCompleteDate; }, cellTemplate: '<div class="ui-grid-cell-contents wrap" white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>', visible: false },
                { field: 'TestCycle', displayName: 'ActHours', enableCellEdit: false, width: '7%', cellTooltip: function (row) { return row.entity.TestCycle; }, cellTemplate: '<div class="ui-grid-cell-contents wrap" white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>', visible: false },
                ...
                { field: 'AssignedTo', displayName: 'Assigned', width: '7%', enableCellEdit: false, visible: false},
        ...
        $scope.gridOptions.onRegisterApi = function (gridApi) {
            ...
            gridApi.selection.on.rowSelectionChanged($scope, function (row) {
                ...
                if (row.isSelected) {  //rowchecked 
                    ...
                    document.getElementById('TaskStatus').value = row.entity.Status;
                    document.getElementById('TaskStatusDropdown').value = row.entity.Status;
                    document.getElementById('TaskDescription').value = row.entity.Description;
                    document.getElementById('Type').value = row.entity.Type;
                    document.getElementById('TypeDropdown').value = row.entity.Type;
                    document.getElementById('EnteredByTasks').value = row.entity.EnteredBy;
                    document.getElementById('EnteredByDropdownTasks').value = row.entity.EnteredBy;
                    document.getElementById('TaskAssignedTo').value = row.entity.AssignedTo;
                    document.getElementById('AssignedToDropdown').value = row.entity.AssignedTo;
                    document.getElementById('TaskComment').innerHTML = row.entity.Comment;
                    ...
                    ////$scope.populateImg('TaskComment', 'Base64Output1', '#photo-id1', str1);

                    document.getElementById('TaskTotalHoursSpentAPPS').value = row.entity.TotalHoursSpentAPPS;
                    ...
                    document.getElementById('row_idTasks').value = row.entity.row_id;
    ...
    $scope.addMainProject = function () {
        if (document.getElementById('BusReqCompleteDate').value === "" || document.getElementById('BusReqCompleteDate').value === "1900-01-01") { //|| document.getElementById('PlanStartDate'.value) === "" || document.getElementById('PlanStartDate').value === "1900-01-01" || document.getElementById('PlanCompleteDate'.value) === "" || document.getElementById('PlanCompleteDate').value === "1900-01-01") {
            ...
            var StatusValue = document.getElementById('TaskStatus').value;
            var DescriptionValue = document.getElementById('TaskDescription').value;
            var TypeValue = document.getElementById('Type').value;
            var TestCycleValue = document.getElementById('orgCommittedDate').value;
            var EnteredByValue = document.getElementById('EnteredByDropdownTasks').value;
            var AssignedToValue = document.getElementById('AssignedToDropdown').value;
            var CommentValue = document.getElementById('TaskComment').innerHTML + '<img src=' + document.getElementById('Base64Output1').value + '>';
            var TotalHoursSpentAPPSValue = document.getElementById('TaskTotalHoursSpentAPPS').value;
            ...
            var row_idValue = document.getElementById('row_idTasks').value;
            ...
            DefectService.addDefect(ProjectNameValue, DefectNameValue, PriorityValue, StatusValue, DescriptionValue, TypeValue, TestCycleValue, EnteredByValue, AssignedToValue, CommentValue, TotalHoursSpentAPPSValue, EstStartDateValue, EstCompleteDateValue, row_idValue, ProdAreaValue, PercentRespValue, PlanStartDateValue,PlanCompleteDateValue, BusReqCompleteDateValue).success(function (data) {
                    ...
                    document.getElementById('TaskStatusDropdown').value = "SelectStatus";
                    document.getElementById('TaskDescription').value = "";
                    document.getElementById('Type').value = "";
                    document.getElementById('TypeDropdown').value = "SelectType";
                    document.getElementById('TestCycle').value = "";
                    document.getElementById('EnteredByTasks').value = "";
                    document.getElementById('EnteredByDropdownTasks').value = "SelectRequestor";
                    ...
                    document.getElementById('TaskTotalHoursSpentAPPS').value = "";
                    document.getElementById('EstStartDate').value = "";
                    document.getElementById('EstCompleteDate').value = "";
                    document.getElementById('row_idTasks').value = "";
    ...
    $scope.copyOfTask = function () {
        ...
        if (document.getElementById('BusReqCompleteDate').value === "" || document.getElementById('BusReqCompleteDate').value === "1900-01-01") {//(document.getElementById('EstStartDate').value === "" || document.getElementById('EstStartDate').value === "1900-01-01" || document.getElementById('EstCompleteDate'.value) === "" || document.getElementById('EstCompleteDate').value === "1900-01-01") {
            ...
            if (document.getElementById('CopyAssignedToDropdown').value !== "") {
                document.getElementById('row_idTasks').value = "";
                row_idValue = document.getElementById('row_idTasks').value;
        ...
        $scope.defaultGridTasks = function () {
            $scope.clearFilters();
            var job = document.getElementById('labeltask').value;
            $scope.gridApi.grid.getColumn('DefectName').filters[0] = {
                term: job
            };
    ...
    $scope.undoUpdate = function () {
        ...
        document.getElementById('TestCycle').value = "";
        document.getElementById('EnteredByTasks').value = "";
        document.getElementById('EnteredByTasks').value = "SelectRequestor";
        document.getElementById('TaskAssignedTo').value = "";
        document.getElementById('TaskAssignedTo').value = "SelectAssignee";
        document.getElementById('TaskComment').innerHTML = "";
        //document.getElementById('1').innerHTML = "";
        document.getElementById('TaskTotalHoursSpentAPPS').value = "";
        document.getElementById('EstStartDate').value = "";
    ...
    $scope.clearTB = function () {
        ...
        document.getElementById('TaskStatus').value = '';
        document.getElementById('TaskStatusDropdown').value = '';
        document.getElementById('TaskDescription').value = '';
        document.getElementById('Type').value = '';
        document.getElementById('TypeDropdown').value = '';
        document.getElementById('TestCycle').value = '';
        document.getElementById('EnteredByTasks').value = '';
        document.getElementById('EnteredByDropdownTasks').value = '';
        document.getElementById('TaskAssignedTo').value = '';
    ...
    $scope.clear = function () {
        $scope.dt = null;
            ...
            $scope.start = function () {
                if (document.getElementById('TaskStatusDropdown').value === '1-InQueue' || document.getElementById('TaskStatusDropdown').value === '0-Entry') {
                    if (document.getElementById('BusReqCompleteDate').value !== '' && document.getElementById('PlanStartDate').value !== '' && document.getElementById('PlanCompleteDate').value !== '') {
                        document.getElementById('TaskStatusDropdown').value = '2-InProgress';
                        document.getElementById('TaskStatus').value = '2-InProgress';
                ...
                else if (document.getElementById('TaskStatusDropdown').value === '2-InProgress') {
                    if (document.getElementById('BusReqCompleteDate').value !== '' && document.getElementById('PlanStartDate').value !== '' && document.getElementById('PlanCompleteDate').value !== '') {
                        document.getElementById('TaskStatusDropdown').value = '4-Complete';
                        document.getElementById('TaskStatus').value= '4-Complete';
                        var todayC = new Date();
            ...
            $scope.TaskInit = function () {
                ...
                if (document.getElementById('TaskStatusDropdown').value === '2-InProgress') {
                    document.getElementById('2Task').style.pointerEvents = 'auto';
                    document.getElementById('7').style.backgroundColor = 'darkslategrey';
                    //document.getElementById('2Task').style.backgroundColor = 'lightgreen';
                    document.getElementById('PlanCompleteDate').disabled = true;
                    document.getElementById('PlanStartDate').disabled = true;
                    document.getElementById('btnStart').innerHTML = 'Complete';
                ...
                else if (document.getElementById('TaskStatusDropdown').value === '4-Complete') {
                    document.getElementById('2Task').style.pointerEvents = 'none';
        ...
        $scope.showComments = function () {
            //$scope.columnDefs[12].visible = true;
              ...
              //  this.columns.push({ field: 'TaskComment', enableSorting: false });
        ...
        document.getElementById('TaskComment').onpaste = function (event) {
            ...
            if (blob !== null) {
                ...
                reader.onload = function (event) {
                    ...
                    document.getElementById("TaskComment").appendChild(elem);
        ...
        $scope.ChooseAssignedTo = function (data) {
            ...
            document.getElementById("TaskAssignedTo").value = data.value;
            //}
            //else {
        ...
        $scope.paste = function () {
            ...
            document.getElementById('TaskComment').value = sRetrieveData;
        ...
        $scope.maximize = function (nav) {
            ...
            document.getElementById('2Task').style.display = "none";
            ...
            document.getElementById('TaskComment').style.width = "90%";
            document.getElementById('TaskComment').style.height = "90%";
            //}
            //nav++;
        };
        ...
        $scope.restore = function (nav) {
            ...
            document.getElementById('2Task').style.display = "block";
...
function ChooseStatus(data) {
    ...
    document.getElementById("TaskStatus").value = data.value;
...
function ChooseEnteredBy(data) {
    ...
    document.getElementById("EnteredByTasks").value = data.value;
    ...
    if (st !== '4-Complete') {
        ...
        if (document.getElementById('DepID').value !== '') {
            if (document.getElementById('DepStatus').value === '4-Complete') {
                ...
                document.getElementById("TaskStatusDropdown").value = document.getElementById("TaskStatus").value;
