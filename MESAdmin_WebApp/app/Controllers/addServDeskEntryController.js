(function () {
    angular
        .module('myApp')
        .controller('addServDeskEntrycontroller', controller)

    controller.$inject = ['$scope', '$timeout', 'uiGridConstants', 'addServDeskEntryService'];
    ...
    function controller($scope, $timeout, uiGridConstants, addServDeskEntryService) {
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                {
                    field: 'TruckId', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'ReceiptDate', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'ItemType', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Item', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Status', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'SentTOSAP', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'LoadType', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'LoadNumber', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'ScaleDown', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Tank1TruckId', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Tank2TruckId', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Route1', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Route2', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'ScaleInTime', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'ScaleOutTime', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'ActualGross', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'ActualTare', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'ActualNet', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'HaulerId', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Trailer1Id', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Trailer2Id', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'TrailerLicense1', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'TrailerLicense2', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Btu1', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Btu2', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Fips1', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Fips2', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'OperatorInitials', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Comments', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Bay', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'BayInTime', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Silo1', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Silo2', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Silo3', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Silo4', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'ScanCard', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'Supervisor', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'ManufactureDate', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'TruckInBayTime', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
                {
                    field: 'RowId', width: '10%', enableCellEdit: false,
                    cellTemplate: '<div class=ui-grid-cell-contents wrap white-space: normal title="TOOLTIP">{{COL_FIELD CUSTOM_FILTERS}}</div>'
                },
