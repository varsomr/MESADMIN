(function () {
    ...
    angular
        ...
        .controller('ChangeMgmtcontroller', controller);//.controller('StaticController', controllerstaticgrid);
    ...
    function controller($scope, $timeout, uiGridConstants, ChangeMgmtService) {
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                {
                    field: 'Status', displayName: 'RelStatus', width: '10%', enableCellEdit: false, cellFilter: 'StatusFilter', editableCellTemplate: 'ui-grid/dropdownEditor',
